...
// Peripheral abstraction layer for the stm32h563 - based off of the stm32l0, thanks!
...
var deviceIDAddr = []uintptr{0x08FFF800, 0x08FFF804, 0x08FFF808}
...
const APB3_TIM_FREQ = 32e6 // 32MHz
const AHB1_TIM_FREQ = 32e6 // 32MHz
